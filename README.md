...
Building footprint data, essential for identifying the exact location and shape of buildings, has become a foundation of urban Geographic Information Systems (GIS). With the advent of advanced artificial intelligence and remote sensing technologies, the automatic extraction of building footprints from high-resolution satellite imagery has garnered considerable interest. Techniques like Convolutional Neural Networks (CNN) and Transformers have shown remarkable proficiency in delineating building footprints from complex satellite images swiftly and accurately. Nonetheless, the inherent diversity of buildings in terms of shape, color, and size, alongside regional variations in environmental and land-use characteristics, presents substantial challenges. Extraction algorithms must be both flexible and adept, capable of discerning and recognizing building features across diverse settings. This necessitates algorithms that not only exhibit strong generalization capabilities but also maintain high accuracy levels, particularly for nationwide extraction tasks. This competition embarks on this challenge by utilizing a building footprint dataset from the Tokyo area as the primary training set, with plans to extend testing to other Japanese regions. This approach aims to inspire the development of models with robust generalization capabilities, capable of overcoming the hurdles of automatic building footprint detection and extraction across various landscapes.
